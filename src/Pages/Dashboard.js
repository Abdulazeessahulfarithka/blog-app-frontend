  ...
  return (
    <>
      <div className="text-center mt-8 space-y-4">
        ...
        <div className="mt-4">
        <Link   className="bg-green-500 text-white font-semibold py-2 px-4 rounded-md focus:outline-none focus:ring-2 focus:ring-green-600 focus:ring-opacity-50" to="/login">
  Create Blog
</Link>
